...
pub fn main() void {
    ...
    const zen_manyptr: [*]const u8 = zen12; // this is a pointer to unknown number of immutable u8
    ...
    const zen12_string: []const u8 = zen_manyptr[0..21]; // a slice needs to has a specified size
